...
namespace SONO {
	...
	namespace COMP {
		...
		enum {
			SONO_ACTION_EXCEPTION_UNSUPPORTED = 0,
		};

		#define SONO_ACTION_EXCEPTION_MAX SONO_ACTION_EXCEPTION_UNSUPPORTED

		static const std::string SONO_ACTION_EXCEPTION_STR[] = {
			SONO_ACTION_EXCEPTION_HEADER "Action is not supported",
			};
