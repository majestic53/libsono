...
namespace SONO {
	...
	namespace COMP {
		...
		enum {
			...
			SONO_DEVICE_EXCEPTION_GET_RESPONSE,
			SONO_DEVICE_EXCEPTION_SERVICE_ALLOCATED,
			SONO_DEVICE_EXCEPTION_SERVICE_DISCOVERY,
			SONO_DEVICE_EXCEPTION_SERVICE_NOT_FOUND,
			SONO_DEVICE_EXCEPTION_SERVICE_UNSUPPORTED,
		...
		static const std::string SONO_DEVICE_EXCEPTION_STR[] = {
			...
			SONO_DEVICE_EXCEPTION_HEADER "Failed to allocate device service",
			SONO_DEVICE_EXCEPTION_HEADER "Device service discovery failed",
			SONO_DEVICE_EXCEPTION_HEADER "Device service does not exist",
			SONO_DEVICE_EXCEPTION_HEADER "Device service is not supported",
